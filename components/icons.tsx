...
export const LogsIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className}>
    <path d="M15.385 15.385a7.5 7.5 0 10-10.607-10.607 7.5 7.5 0 0010.607 10.607zM21 21l-4.35-4.35" stroke="#60a5fa" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M12 13a3 3 0 100-6 3 3 0 000 6z" fill="#ef4444"/>
    <path d="M10 7.5l-2-1.5" stroke="#f87171" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M14 7.5l2-1.5" stroke="#f87171" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M10 15.5l-2 1.5" stroke="#f87171" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M14 15.5l2 1.5" stroke="#f87171" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className={className}>
    <defs>
      <linearGradient id="settings-grad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="rgb(var(--color-primary-accent))" />
        <stop offset="100%" stopColor="rgb(var(--color-primary))" />
      </linearGradient>
    </defs>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.008 1.11-1.226a2.25 2.25 0 012.59 1.226c.275.639.275 1.345 0 1.984a2.25 2.25 0 01-2.59-1.226c-.55-.218-1.02-.684-1.11-1.226zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" stroke="url(#settings-grad)" strokeWidth="1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" stroke="url(#settings-grad)" strokeWidth="1.5" />
  </svg>
);
...
export const UserIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.93" />
    </svg>
);
